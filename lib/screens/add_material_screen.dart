...
class _AddMaterialScreenState extends State<AddMaterialScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    DocumentReference reference =  FirebaseFirestore.instance.collection("Materials").
    doc(semester).collection(branch).doc(id);

    DocumentReference ref =  FirebaseFirestore.instance.collection("Materials").
    doc(semester);
    ...
    void uploadResult() async {
      ...
      try {
        Map<String,dynamic> data = {
          ...
          'subName' : _subjectName.text,  // Updating Document Reference
          'subTopic' : _subjectTopic.text,  // Updating Document Reference
          'materialUrl' : url, // Updating Document Reference
          'materialId' : id, // Updating Document Reference
